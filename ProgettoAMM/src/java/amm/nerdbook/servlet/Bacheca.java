...
public class Bacheca extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //supponiamo di averlo dalla login
        UtenteRegistrato u = UtenteRegistratoFactory.getInstance().getUtentiRegistratiById(0);
        List<Post> l = PostFactory.getInstance().getPostList(u);
        
        request.setAttribute("listaPost",  l);
